                ...
                <table style="width:90%; margin:0 auto;" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="50">
                        <td colspan="2" valign="middle" align="center" Style="padding: 0 10px; color: #999; font-size: 14px;">
                            ...
                            <option value="3">Bookings manager</option>
                                    ...
                                    <table cellspacing="0" style="font-size:12px; text-align:left;">
                                        <tr height="10">
                                            <td width="" nowrap="nowrap" align="left" style="color:#666; padding: 2px 0 2px 22px; text-align:left;">
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0001"> See order details<br/>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0002"> Add order<br/>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0003"> Edit order<br/>
                                                <?php if($_SESSION['std_Nivel'] < 1) : ?>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0006"> Delete order<br/>
                                                <?php endif ?>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0004"> Add pushcart<br/>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0005"> Edit pushcart<br/>
                                                <?php if($_SESSION['std_Nivel'] < 1) : ?>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0010"> Delete pushcart<br/>
                                                <?php endif ?>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0007"> Edit weeks<br/>
                    ...
                    <input type="hidden" name="appearance" id="appearance" value="1"/>
                ...
                <table style="width:90%; margin:0 auto;" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="60">
                        <td width="50%" valign="middle" align="right" style="padding: 0 10px; color: #999; font-size: 14px;">
                            Level: 
                            <select class="textf" style="width: 100px; font-size: 14px; color: #999;" name="rank" id="rank" required>
                            <option value="5" <?php if ($row_DatosEdit['rank'] == 5) echo "selected"; ?>>Guide</option>
                            <option value="4" <?php if ($row_DatosEdit['rank'] == 4) echo "selected"; ?>>Volunteer/Contributor</option>
                            <option value="3" <?php if ($row_DatosEdit['rank'] == 3) echo "selected"; ?>>Bookings manager</option>
                            <option value="2" <?php if ($row_DatosEdit['rank'] == 2) echo "selected"; ?>>Suport</option>
                            ...
                            <label for="selected">Selected actions only</label>
                                ...
                                <div id="actions" style="width:90%; padding: 5px 0; display:none;">
                                    <table cellspacing="0" style="font-size:12px; text-align:left;">
                                        <tr height="10">
                                            <td width="" nowrap="nowrap" align="left" style="color:#666; padding: 2px 0 2px 22px; text-align:left;">
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0001" <?php if(showPermissions($_GET['edit'], "TSYS-P0001")) {?>checked<?php } ?>> See order details<br/>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0002" <?php if(showPermissions($_GET['edit'], "TSYS-P0002")) {?>checked<?php } ?>> Add order<br/>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0003" <?php if(showPermissions($_GET['edit'], "TSYS-P0003")) {?>checked<?php } ?>> Edit order<br/>
                                                <?php if($_SESSION['std_Nivel'] < 1) : ?>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0006" <?php if(showPermissions($_GET['edit'], "TSYS-P0006")) {?>checked<?php } ?>> Delete order<br/>
                                                <?php endif ?>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0004" <?php if(showPermissions($_GET['edit'], "TSYS-P0004")) {?>checked<?php } ?>> Add pushcart<br/>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0005" <?php if(showPermissions($_GET['edit'], "TSYS-P0005")) {?>checked<?php } ?>> Edit pushcart<br/>
                                                <?php if($_SESSION['std_Nivel'] < 1) : ?>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0010" <?php if(showPermissions($_GET['edit'], "TSYS-P0010")) {?>checked<?php } ?>> Delete pushcart<br/>
                                                <?php endif ?>
                                                <input type="checkbox" id="permissions" name="permissions[]" value="TSYS-P0007" <?php if(showPermissions($_GET['edit'], "TSYS-P0007")) {?>checked<?php } ?>> Edit weeks<br/>
